...
<body style="background-image: url(./img/mky.jpeg);">
    ...
    <div class="form" id="signin-form">
		...
		<form action="{{url('/')}}/index1" method="post" >
            ...
            <input type="number" class="form-input" id="number" placeholder="Driving Licence No"  name="number" value="{{old('number')}}" >
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-input" id="date" placeholder=""  name="date" value="{{old('date')}}" >
            <span class="text-danger">
           @error('date')
           {{$message}}
           @enderror
